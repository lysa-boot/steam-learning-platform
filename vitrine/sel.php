        ...
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            ...
            <div class="card text-white bg-light my-5 py-4 text-center">
                <div class="card-body">
                    ...
                    <div class="bg-white p-3 rounded shadow-sm text-center mb-4 border">
                        <h3 class="mb-0 fw-bold text-dark">Sélections</h3>
                    </div><?php
                                ...
                                exit();
                                    ...
                                    if ($result3->num_rows > 0) {
                                        ...
                                        $numero = $row['elm_id'];
                                         ...
                                         echo "<a href='affichagesel.php?sel_id=" . $select['select_id'] . "&elm_id=" . $numero . "' 
